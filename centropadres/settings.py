...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-u!-dzha6pnfmfi*p%&)-u5x(ogj7t*u(t9!_jdll!t#cgf8-02')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.environ.get('DEBUG', 'False') == 'True'

ALLOWED_HOSTS = os.environ.get('ALLOWED_HOSTS', '127.0.0.1,localhost,https://centropadres.onrender.com, 0.0.0.0').split(',')
...
ROOT_URLCONF = 'centropadres.urls'
...
WSGI_APPLICATION = 'centropadres.wsgi.application'
...
STATIC_ROOT = BASE_DIR / 'staticfiles' # Ensure this is outside the project directory for collectstatic
MEDIA_URL = '/media/'
...
LOGIN_REDIRECT_URL = '/perfiles/mi-perfil/'
LOGOUT_REDIRECT_URL = '/'
...
# Security Headers (apply only when DEBUG is False)
if not DEBUG:
    ...
    X_FRAME_OPTIONS = 'DENY' # Or 'SAMEORIGIN' if you need iframes from the same domain